...
books_df = pd.read_csv('bestseller.csv')
...
st.subheader("Top 10 Authors by Counts of the books Published (2009-2022")
top_authors = books_df['Author'].value_counts().head(10).reset_index()
top_authors.columns = ['Author', 'Counts']
fig = px.bar(top_authors, x='Counts', y='Author', orientation='h', title='Top 15 Authors by Counts of the books Published', color='Counts',
